...
RUN mkdir -p /app/static/vendor /app/static/fonts /app/static/assets
COPY frontend/vendor /app/static/vendor
COPY frontend/fonts /app/static/fonts 2>/dev/null || true
RUN cp /app/frontend/*.webp /app/static/ 2>/dev/null || true
RUN cp /app/frontend/*.png /app/static/ 2>/dev/null || true
RUN cp /app/frontend/*.ico /app/static/ 2>/dev/null || true
...
RUN echo 'server { listen 80; server_name localhost; root /app/frontend; index index.html; location /static { alias /app/static; } location / { try_files $uri $uri/ /index.html; } location /set_state { proxy_pass http://127.0.0.1:19000; } location /status { proxy_pass http://127.0.0.1:19000; } location /agents { proxy_pass http://127.0.0.1:19000; } }' > /etc/nginx/conf.d/star.conf
